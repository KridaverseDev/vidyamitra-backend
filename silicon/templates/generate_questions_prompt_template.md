...
Generate {count} high-quality, contextually relevant questions for the course {course}. 
Each question should be worth 10 marks. Some questions can be split into two parts: (a) and (b),
each worth 5 marks. Ensure that questions are appropriately numbered (e.g., 1.a, 1.b, 2.a, 2.b), 
...
1. **Difficulty Levels**: 
    Distribute questions among three difficulty levels according to this distribution {difficulty_distribution}
...
2. **Bloom's Levels**: 
    Distribute questions strictly according to the {blooms_distribution}, ensuring a balanced assessment 
